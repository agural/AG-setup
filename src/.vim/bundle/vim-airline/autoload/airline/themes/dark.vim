...
" The dark.vim theme:
let s:airline_a_normal   = [ '#5fff00' , '#4e4e4e' , 82  , 239 ]
let s:airline_b_normal   = [ '#5fff00' , '#3a3a3a' , 82  , 237 ]
let s:airline_c_normal   = [ '#5fff00' , '#262626' , 82  , 235 ]
...
let g:airline#themes#dark#palette.normal_modified = {
      \ 'airline_c': [ '#d70000' , '#262626' , 160 , 235 , ''     ] ,
      \ }
